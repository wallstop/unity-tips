...
> **The ONLY Unity animation library with ZERO garbage collection.** Fast, simple, and Inspector-friendly.

PrimeTween is a high-performance, allocation-free tweening library for Unity. It lets you animate transforms, UI, audio, cameras, and custom data with one-line calls while keeping every animation configurable in the Inspector. Compared to DOTween and LeanTween, PrimeTween is **2.6x faster**, never allocates memory, and has a simpler API.
...
**💪 [Why PrimeTween?](02-WHY-PRIMETWEEN.md)** — *20-minute read*
...
**📖 [API Reference](03-API-REFERENCE.md)** — *Reference*
...
**⚠️ [Anti-Patterns & Pitfalls](05-ANTI-PATTERNS.md)** — *What NOT to do*
...
Every allocation triggers garbage collection, causing frame stutters. PrimeTween **never allocates** — not even once. DOTween allocates 734-2,846 bytes per tween. LeanTween allocates 292-877 bytes. PrimeTween allocates **0 bytes**.
...
PrimeTween has **8 top-level concepts**. DOTween has ~30. You can learn the entire PrimeTween API in under an hour.
...
- **[Official GitHub](https://github.com/KyryloKuzyk/PrimeTween)** — Source code, issues, discussions
...
- **[Performance Benchmarks](https://github.com/KyryloKuzyk/PrimeTween/discussions/10)** — Official comparison data
...
**Before PrimeTween** (DOTween): ~300KB GC per minute in intense scenes
**After PrimeTween**: 0 bytes GC from animations
...
**Migrating from DOTween/LeanTween?**
→ Read [Why PrimeTween?](02-WHY-PRIMETWEEN.md#migration-difficulty)

**Need specific examples?**
→ Browse [Common Patterns](04-COMMON-PATTERNS.md)

**Want full API docs?**
→ See [API Reference](03-API-REFERENCE.md)

**Avoiding mistakes?**
→ Study [Anti-Patterns](05-ANTI-PATTERNS.md)
