...
> **Quick Reference**: Feel includes 150+ feedbacks across 15 categories. Use this guide to find the perfect feedback for your needs.
...
- [Haptics](#haptics-nice-vibrations) | [Light](#light) | [Materials](#materials--renderer) | [Particles](#particles)
...
**Pro Tip**: Use lower Amplitude (0.1-0.3) for subtle effects like UI feedback. Use higher (1.0+) for explosions.
...
**Pro Tip**: Always return time scale to 1.0! Add a second feedback with delay or use "Restore Time Scale" mode.
...
**Need dramatic moments?** → Post Processing (Bloom, Vignette, Chromatic Aberration), Camera Zoom, Slow Motion
...
**Pro Tip**: Don't try to memorize all feedbacks — use the Inspector's search bar! Type "shake" to find all shake-related feedbacks instantly.
